        ...
        <section class="Info-reputacion">
            ...
            <div class="reput-info">
                <div class="contenidor">
                    <h2 class="tittle">Sistema de reputacion</h2>
                    <p>En Circula la confianza es fundamental,nuestro sistema de reputacion ayuda a identificar a los
                        usuarios
                        mas confiables. </p>
                    <img src="" alt="">
                    <h3>Valoraciones Transparentes</h3>
                    <p>Cada interaccion recine una valoracion que contruye la reputacion del usuario.</p>

                    <img src="" alt="">
                    <h3>Usuarios Destacados </h3>
                    <p>Los usuarios con mejores Valoraciones se destacan como mas confiables.</p>

                    <img src="" alt="">
                    <h3>Beneficios por reputacion </h3>
                    <p>Accede a funciones exclusivas a medida que mejora la reputacion</p>
                </div>
